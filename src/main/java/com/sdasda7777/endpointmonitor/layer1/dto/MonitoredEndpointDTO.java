...
public class MonitoredEndpointDTO
{
	...
	/**
	 * Constructor for MonitoredEndpointDTO which automatically takes all
	 * relevant data from the passed
	 * MonitoredEndpoint entity
	 *
	...
	/**
	 * Constructor for MonitoredEndpointDTO which takes relevant data as
	 * arguments
	 *
	...
	/**
	 * Converts collection of MonitoredEndpoints to collection of
	 * MonitoredEndpointDTOs
	 *
	 * @param endpoints collection of endpoint entities
	 * @return collection of MonitoredEndpointDTOs describing provided
	 * endpoint entities
	 */
